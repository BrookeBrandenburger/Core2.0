    ...
    try:
        ...
        if current_loop[current_gene_idx][0] == False:
            ...
            if checkConditionalResult:
                ...
                current_gene_idx = ((current_gene_idx + 1) % 9) # Move to next loop in the gene (max 15)
        else: 
